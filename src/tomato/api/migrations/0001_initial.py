# Generated by Django 2.0.2 on 2018-03-10 01:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_id', models.CharField(max_length=255, null=True)),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.ServiceBody')),
                ('root_server', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.RootServer')),
            ],
        ),
        migrations.AddField(
            model_name='meeting',
